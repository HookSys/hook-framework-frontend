...
export class RoleControllerService extends BaseService {
  ...
  /**
   * Path part for operation roleControllerCount
   */
  static readonly RoleControllerCountPath = '/roles/count';
  ...
  count$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoleControllerService.RoleControllerCountPath, 'get');
    if (params) {
  ...
  /**
   * Path part for operation roleControllerReplaceById
   */
  static readonly RoleControllerReplaceByIdPath = '/roles/{id}';
  ...
  replaceById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoleControllerService.RoleControllerReplaceByIdPath, 'put');
    if (params) {
  ...
  /**
   * Path part for operation roleControllerDeleteById
   */
  static readonly RoleControllerDeleteByIdPath = '/roles/{id}';
  ...
  deleteById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoleControllerService.RoleControllerDeleteByIdPath, 'delete');
    if (params) {
  ...
  /**
   * Path part for operation roleControllerUpdateAll
   */
  static readonly RoleControllerUpdateAllPath = '/roles';
  ...
  updateAll$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, RoleControllerService.RoleControllerUpdateAllPath, 'patch');
    if (params) {
